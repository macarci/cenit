module Mongoff
  module Validator
    ...
    def check_schema_items(value)
      _check_type(:items, value, Hash, Array)
      if value.is_a?(Hash)
        validate(value)
      else # Is an array
        raise "array of schemas for items is not yet supported" # TODO Support array of schemas for items
      end
    end
    ...
    def check_properties(properties, instance, _, data_type, options)
